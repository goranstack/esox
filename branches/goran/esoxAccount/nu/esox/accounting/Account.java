...
public class Account extends NamedAndNumbered implements XmlWriter.Writeable
{
    ...
    public static final Type [] TYPES =
    {
        ...
        TYPE_SALES_REVENUE,
        TYPE_OTHER_REVENUE,
        TYPE_MATERIAL_EXPENSES,
        TYPE_OTHER_EXPENSES,
        TYPE_WRITE_OFFS,
        TYPE_FINANCIAL_REVENUE,
        TYPE_FINANCIAL_EXPENSES,
        TYPE_EXTRAORDINARY_RESULT,
        TYPE_RESULT,
    };
    ...
    public final Type getType() { return m_type; }
    ...
    public final boolean hasIb() { return m_type.hasIb(); }
    public final boolean hasBudget() { return m_type.hasBudget(); }

    public final boolean isLocked() { return m_locked; }
    ...
    public Type xmlCreate_type_turnover_asset( Object superModel, Attributes a ) { return m_type = TYPE_TURNOVER_ASSET; }
    public Type xmlCreate_type_facility_asset( Object superModel, Attributes a ) { return m_type = TYPE_FACILITY_ASSET; }
    public Type xmlCreate_type_short_dept( Object superModel, Attributes a ) { return m_type = TYPE_SHORT_DEPT; }
    public Type xmlCreate_type_long_dept( Object superModel, Attributes a ) { return m_type = TYPE_LONG_DEPT; }
    public Type xmlCreate_type_own_capital( Object superModel, Attributes a ) { return m_type = TYPE_OWN_CAPITAL; }
    public Type xmlCreate_type_sales_revenue( Object superModel, Attributes a ) { return m_type = TYPE_SALES_REVENUE; }
    public Type xmlCreate_type_other_revenue( Object superModel, Attributes a ) { return m_type = TYPE_OTHER_REVENUE; }
    public Type xmlCreate_type_material_expenses( Object superModel, Attributes a ) { return m_type = TYPE_MATERIAL_EXPENSES; }
    public Type xmlCreate_type_other_expenses( Object superModel, Attributes a ) { return m_type = TYPE_OTHER_EXPENSES; }
    public Type xmlCreate_type_write_offs( Object superModel, Attributes a ) { return m_type = TYPE_WRITE_OFFS; }
    public Type xmlCreate_type_financial_revenue( Object superModel, Attributes a ) { return m_type = TYPE_FINANCIAL_REVENUE; }
    public Type xmlCreate_type_financial_expenses( Object superModel, Attributes a ) { return m_type = TYPE_FINANCIAL_EXPENSES; }
    public Type xmlCreate_type_extraordinary_result( Object superModel, Attributes a ) { return m_type = TYPE_EXTRAORDINARY_RESULT; }
    public Type xmlCreate_type_result( Object superModel, Attributes a ) { return m_type = TYPE_RESULT; }
    ...
    public static final class Type implements XmlWriter.UnsharedWriteable
    {
        ...
        private boolean hasIb() { return m_hasIb; }
        private boolean hasBudget() { return m_hasBudget; }
        public String xmlGetTag() { return "type-" + m_id; }
        public void xmlWriteSubmodels( XmlWriter w ) {}
        public void xmlWriteAttributes( XmlWriter w ) {}
