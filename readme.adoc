// Badges
image:https://github.com/goranstack/esox/actions/workflows/build.yml/badge.svg["Build Status", link="https://github.com/goranstack/esox/actions/workflows/build.yml"]
