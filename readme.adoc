...
There are no plans for extensive further development but some minor improvements will be implemented over time.
Java Swing will be replaced by JavaFx and since JavaFx contains its own binding solution there will be no future support for JavaFx.
